...
function sendButton(){
    event.preventDefault()
        ...
        fetch('https://docccitablog.herokuapp.com/simple_chatbot/', {
        method: 'POST', 
        headers: {
        ...
        .catch((error) => {
            ds.appendChild(document.createTextNode('Sorry Try Again ,first create your username and login with ur credentials then you can make blogs(in navigation->BlogNow) you can see your blogs in myBlogs(only your blogs) then you can check history and logout -'))
            dp.appendChild(ds)
            dbox.appendChild(dp)
            container.appendChild(dbox)
        message=''
